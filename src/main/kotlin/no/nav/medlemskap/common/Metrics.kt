...
fun configureSensuInfluxMeterRegistry(): SensuInfluxMeterRegistry {
    val config: SensuInfluxConfig =
        object : SensuInfluxConfig {
...
fun ytelseCounter(ytelse: String): Counter =
    Counter
...
fun regelUendretCounterMidlertidig(
    regelId: RegelId,
    svar: Svar,
    ytelse: Ytelse,
): Counter =
    Counter // Når dekning kan returneres av tjenesten kan denne fjernes.
...
fun samletStillingsprosentCounter(
    stillingsprosent: Double,
    ytelse: String,
): Counter =
...
fun merEnn10ArbeidsforholdCounter(ytelse: Ytelse): Counter =
    Counter
...
fun usammenhengendeArbeidsforholdCounter(ytelse: Ytelse): Counter =
    Counter
...
fun harIkkeArbeidsforhold12MndTilbakeCounter(ytelse: Ytelse): Counter =
    Counter
...
fun antallDagerUtenArbeidsforhold(ytelse: Ytelse): DistributionSummary =
    DistributionSummary
...
fun antallDagerMellomArbeidsforhold(ytelse: Ytelse): DistributionSummary =
    DistributionSummary
