...
suspend fun defaultCreateDatagrunnlag(
    ...
    coroutineScope {
        ...
        val dataOmBrukersBarn =
            familieService.hentDataOmBarn(
        ...
        val dataOmEktefelle =
            familieService.hentDataOmEktefelle(
        ...
        val oppholdstillatelse =
            if (FeatureToggles.FEATURE_UDI.enabled &&
                personHistorikk.statsborgerskap.erAnnenStatsborger(startDatoForYtelse)
            ) {
                val oppholdsstatusRequest =
                    async {
                        try {
