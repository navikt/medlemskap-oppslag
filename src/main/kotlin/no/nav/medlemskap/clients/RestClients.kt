...
class RestClients(
    ...
    fun pdl(endpointBaseURl: String) =
        PdlClient(
            ...
            httpClient,
            pdlRetry,
            configuration.register.pdlApiKey,
        )
