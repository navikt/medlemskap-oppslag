...
enum class RegelId(val identifikator: String, val avklaring: String, val neiBegrunnelse: String = "", val jaBegrunnelse: String = "", val uavklartBegrunnelse: String = "") {
    ...
    REGEL_1_3_5("1.3.5", "Er arbeidsforholdet sammenfallende med perioden uten medlemskap?", "", ""),
    REGEL_1_4(
        "1.4",
        "Er hele perioden med medlemskap innenfor 12-måneders perioden?",
        "Det finnes hull i 12-måneders perioden for medlemskap",
    ),
    ...
    REGEL_2(
        "2",
        "Er bruker omfattet av grunnforordningen (EØS)? Dvs er bruker statsborger i et EØS-land inkl. Norge?",
        "Brukeren er ikke statsborger i et EØS-land.",
    ),
    REGEL_3(
        "3",
        "Har bruker hatt et sammenhengende arbeidsforhold i Aa-registeret de siste 12 månedene?",
        "Arbeidstaker har ikke sammenhengende arbeidsforhold siste 12 mnd",
    ),
    ...
    REGEL_7_1(
        "7.1",
        "Er bruker ansatt på et NOR-skip eller NIS-skip med innenriks fartsområde?",
        "Bruker har maritimt arbeidsforhold, men ikke på et NOR-skip eller NIS-skip med innenriks fartsområde",
    ),
    ...
    REGEL_10(
        "10",
        "Er bruker folkeregistrert som bosatt i Norge og har vært det i 12 mnd?",
        "Ikke alle adressene til bruker er norske, eller bruker mangler bostedsadresse",
    ),
    ...
    REGEL_11_2_2(
        "11.2.2",
        "Er brukers barn folkeregistrert som bosatt i Norge?",
        "Brukers barn er ikke folkregistrert som bosatt I Norge",
        "",
        "Ikke alle adressene til barna er norske, eller barn som mangler bostedsadresse",
    ),
    REGEL_11_2_2_1(
        "11.2.2.1",
        "Har bruker uten ektefelle og folkeregistrerte barn jobbet mer enn 100 prosent?",
        "Bruker har ikke jobbet 100% eller mer i løpet av periode.",
    ),
    REGEL_11_2_2_2(
        "11.2.2.2",
        "Har bruker vært i 80 % stilling eller mer de siste 12 mnd?",
        "Bruker har ikke jobbet 80% eller mer i løpet av periode",
    ),
    REGEL_11_2_3(
        "11.2.3",
        "Har bruker vært i minst 80 % stilling de siste 12 mnd?",
        "Bruker har ikke jobbet 80% eller mer i løpet av periode.",
    ),
    REGEL_11_3("11.3", "Har bruker barn i PDL?", "Bruker har ikke barn i pdl"),
    REGEL_11_3_1(
        "11.3.1",
        "Er brukers ektefelle folkeregistrert som bosatt i Norge?",
        "Ikke alle adressene til ektefelle er norske, eller ektefelle mangler bostedsadresse",
    ),
    REGEL_11_3_1_1(
        "11.3.1.1",
        "Har bruker vært i 100 % stilling eller mer de siste 12 mnd?",
        "Bruker har ikke jobbet 100% eller mer i løpet av periode.",
    ),
    REGEL_11_4(
        "11.4",
    ...
    REGEL_11_6_1(
        "11.6.1",
        "Har brukers ektefelle  vært i minst 100 % stilling de siste 12 mnd?",
        "Brukers ektefelle har ikke jobbet 100% eller mer i løpet av periode.",
    ),
    ...
    REGEL_13(
        ...
        "Er bruker død?",
        "",
        "Bruker har dødsdato etter inputperiode, men det påvirker ikke medlemskapet",
        "Bruker er død, men i eller før inputperiode.",
    ),
    REGEL_14(
        "14",
        "Er bruker ansatt i staten eller i en kommune?",
        "Bruker er ikke ansatt i staten eller i en kommune",
        "Bruker er ansatt i staten eller i en kommune",
    ),
    ...
    REGEL_19_2(
        "19.2",
        "Har bruker to ulike oppholdstillatelser som overlapper?",
        "Bruker har ikke to oppholdstillatelser som overlapper",
        "Bruker har to oppholdstillatelser som overlapper",
    ),
    REGEL_19_3(
        "19.3",
        "Har bruker en gyldig oppholdstillatelse 12 måneder bakover og 2 måned fremover i tid?",
        "Bruker har ikke gyldig oppholdstillatelse",
    ),
    ...
    REGEL_19_4(
        "19.4",
        "Når brukers tillatelse er EØS eller EFTA; er brukers ektefelle statsborger i UK?",
        "brukers ektefelle er ikke statsborger i UK",
        "Brukers ektefelle er statsborger i UK",
    ),
    REGEL_19_5(
        "19.5",
        "Svarer UDI-tjenesten uavklart ift arbeidsadgang",
        "UDI-tjenesten svarer ikke uavklart",
        "UDI-tjenesten svarer uavklart",
    ),
    REGEL_19_6(
        "19.6",
        "Har bruker en gyldig arbeidstillatelse 12 måneder bakover og 2 måned fremover i tid?",
        "Bruker har ikke gyldig arbeidstillatelse",
    ),
    ...
    REGEL_19_8(
        ...
        "Opphold på samme vilkår flagget er ikke satt",
        "Opphold på samme vilkår flagget er satt",
    ),
    REGEL_20(
        "20",
        "Har bruker mer enn 80% arbeid i Norge de siste 3 månedene?",
        "Bruker har ikke utført mer enn 80% arbeid de siste 3 månedene",
        "Bruker har utført mer enn 80% arbeid de siste 3 månedene",
    ),
    REGEL_21(
        "21",
        "Er bruker arbeidstaker i kontrollperiode for stønadsområde?",
        "Bruker er ikke arbeidstaker i kontrollperiode for stønadsområde",
        "Bruker er arbeidstaker i kontrollperiode for stønadsområde",
    ),
    REGEL_22(
        "22",
        "Arbeidsforhold siste 12 måneder: finnes det utenlandsopphold i et av disse arbeidsforholdene?",
        "Det finnes ikke utenlandsopphold i et av arbeidsforholdene de siste 12 månedene",
        "Det finnes utenlandsopphold i et av arbeidsforholdene de siste 12 månedene",
    ),
    REGEL_23("23", "Returnerer UDI Ikke oppholdstillatelse eller ikke opphold på samme vilkår?", "", ""),
    REGEL_25(
        "25",
        "Er perioden for utenlandsopphold innenfor siste 12 måneder?",
        "Utenlandsoppholdet er ikke innenfor siste 12 måneder",
        "utenlandsoppholdet er innenfor siste 12 måneder",
    ),
    REGEL_27(
        "27",
        "Når bruker har to statsborgerskap og det ene er norsk, har bruker nylig blitt norsk statsborger?",
        "Bruker har ikke blitt norsk statsborger",
        "Bruker har nylig blitt norsk statsborger",
    ),
    ...
    REGEL_30(
        "30",
        "Har britisk bruker EØS eller EFTA oppholdstillatelse?",
        "Britisk bruker har ikke EØS eller EFTA oppholdstillatelse",
        "Britisk bruker har EØS eller EFTA oppholdstillatelse",
    ),
    REGEL_31(
        "31",
        "Har bruker en permanent oppholdstillatelse?",
        "Bruker har ikke permanent oppholdstillatelse",
        "Bruker har permanent oppholdstillatelse",
    ),
    ...
    REGEL_B(
        "OPPLYSNINGER-GOSYS",
        "Finnes det åpne oppgaver i GOSYS på medlemskapsområdet?",
        "",
        "Det finnes registrerte opplysninger i GOSYS",
    ),
    ...
    REGEL_MEDLEM_KONKLUSJON(
        "LOVME",
        "Er bruker medlem?",
        "Kan ikke konkludere med medlemskap",
        "Bruker er medlem",
        "Kan ikke konkludere med medlemskap",
    ),
