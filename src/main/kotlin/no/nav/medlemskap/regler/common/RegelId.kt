...
enum class RegelId(val identifikator: String, val avklaring: String, val neiBegrunnelse: String = "", val jaBegrunnelse: String = "", val uavklartBegrunnelse: String = "") {
    ...
    REGEL_16("16", "Er bruker frilanser?", "Bruker er ikke frilanser"),
    ...
    REGEL_62("62", "Er en av arbeidsavtalene på over 60% og har den vart i 12 måneder?",  "Bruker har ikke hatt en 60% arbeidsavtale sammenhengende i 12 mnd", "Bruker har hatt en sammenhengende arbeidsavtale på 60% eller mer de siste 12 mnd"),
    ...
    REGEL_UDIVALIDERING("UDIVALIDERING", "Validering"),
    REGEL_UDILOVLIGOPPHOLD("UDILOVLIGOPPHOLD", "Har bruker gyldig oppholdstillatelse?"),
    REGEL_ARBEIDSADGANG("ARBEIDSADGANG", "Har bruker arbeidsadgang?"),
    REGEL_BRITISKEBORTERE("BRITISKEBORGERE", "Er bruker eller brukers ektefelle britisk statsborger?"),
    ...
    REGEL_FRILANSER("FRILANSER", "Er bruker frilanser?"),
