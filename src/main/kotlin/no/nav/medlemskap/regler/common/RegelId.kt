...
enum class RegelId(val identifikator: String, val avklaring: String, val neiBegrunnelse: String = "", val jaBegrunnelse: String = "", val uavklartBegrunnelse: String = "") {
    ...
    REGEL_19_2_1("19.2.1", "Dekker oppholdstillatelsen arbeidsperioden bakover i tid?", "Oppholdstillatelsen dekker ikke arbeidsperioden"),
    ...
    REGEL_19_3_1("19.3.1", "Dekker arbeidstillatelsen arbeidsperioden bakover i tid?", "arbeidstillatelsen dekker ikke arbeidsperioden"),
    REGEL_19_4("19.4", "Er bruker britisk borger?", "", "Bruker er britisk borger"),
