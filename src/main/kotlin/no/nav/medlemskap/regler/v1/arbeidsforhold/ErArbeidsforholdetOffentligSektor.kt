...
class ErArbeidsforholdetOffentligSektor(
    ...
    override fun operasjon(): Resultat {
        return when {
            erArbeidsforholdetOffentligSektor(arbeidsforhold, kontrollPeriodeForArbeidsforhold, ytelse) -> ja(RegelId.REGEL_14.jaBegrunnelse)
            else -> nei(RegelId.REGEL_14.neiBegrunnelse)
        }
    }
