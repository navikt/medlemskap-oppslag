...
class ReglerForEøsBorgere(
    ...
    override fun hentHovedflyt(): Regelflyt {
        ...
        val harBrukerMedBarn80ProsenStillingEllerMerRegelFlyt =
            lagRegelflyt(
        ...
        val harBrukerMedBarnOgEktefelle80ProsentStillingEllerMerRegelFlyt =
            lagRegelflyt(
        ...
        val harBrukerUtenFolkeregistrertEktefelleStillingsprosent100EllerMerRegelFlyt =
            lagRegelflyt(
        ...
        val harBrukerMedFolkeregistrertEktefelleStillingsprosent100EllerMerRegelFlyt =
            lagRegelflyt(
        ...
        val harBrukerMedFolkeregistrerteBarnJobbetMerEnn80ProsentFlyt =
            lagRegelflyt(
        ...
        val harBrukerJobbetMerEnn100ProsentFlyt =
            lagRegelflyt(
        ...
        val harBrukerUtenEktefelleBarnSomErFolkeregistrertFlyt =
            lagRegelflyt(
        ...
        val harBrukerUtenEktefelleBarnFlyt =
            lagRegelflyt(
        ...
        val harBarnloesBrukerMedFolkeregistrertEktefelleJobbetMerEnn100ProsentFlyt =
            lagRegelflyt(
        ...
        val harBrukersEktefelleJobbetMinst100ProsentSiste12MndFlyt =
            lagRegelflyt(
        ...
        val harBrukerJobbetMerEnn80ProsentFlyt =
            lagRegelflyt(
        ...
        val erBarnloesBrukersEktefelleBosattINorgeFlyt =
            lagRegelflyt(
        ...
        val erBrukersEktefelleOgBarnasMorSammePersonFlyt =
            lagRegelflyt(
        ...
        val erBrukerUtenFolkeregistrertEktefelleSittBarnFolkeregistrertFlyt =
            lagRegelflyt(
        ...
        val erBrukerMedFolkeregistrertEktefelleSittBarnFolkeregistrertFlyt =
            lagRegelflyt(
        ...
        val erBrukerMedBarnSittEktefelleBosattINorgeFlyt =
            lagRegelflyt(
        ...
        val harBrukerEktefelleOgBarnFlyt =
            lagRegelflyt(
