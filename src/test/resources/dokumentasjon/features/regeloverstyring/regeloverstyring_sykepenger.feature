...
Egenskap: Regel 0.2: Skal regler overstyres?

  Scenariomal: Regel 0.2 - Overstyring av regler 3, 5 og 12 hvis følgende kriterier er oppfylt:
  - Ytelse sykepenger
  - Norsk statsborger
  ...
  - TODO: Regelen skal bare gjelde brukere som ikke er frilansere eller selvstendig næringsdrivende
    ...
    Når regel "0.2" kjøres med følgende parametre
