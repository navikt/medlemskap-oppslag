...
Egenskap: Regel 1.3.2: Er brukers arbeidsforhold uendret?

  Scenariomal: Regel 1.3.2: Er brukers arbeidsforhold uendret? Ett arbeidsforhold
    ...
    Når regel "1.3.2" kjøres med følgende parametre
    ...
    Eksempler:
      | Til og med dato | Svar | Utfylt begrunnelse |
      |                 | Ja   | Nei                |
      | 08.02.2020      | Ja   | Nei                |
      | 28.01.2020      | Nei  | Ja                 |
      | 29.01.2020      | Nei  | Ja                 |
