...
Egenskap: Regel 1.3.1: Er det periode uten medlemskap innenfor 12 mnd?
  ...
  Scenariomal: Regel 1.3.1: Er det periode uten medlemskap innenfor 12 mnd? Sjekk én periode fra MEDL
    ...
    Eksempler:
      ...
      | Nei       | 01.06.2020      | Ja   | Nei                | Avsluttet periode uten medlemskap etter inputperiode                                    |
      | Nei       | 02.02.2020      | Ja   | Nei                | Avsluttet periode uten medlemskap i inputperiode                                        |
      | Nei       | 29.01.2020      | Ja   | Nei                | Avsluttet periode uten medlemskap samtidig med singelinput (inputperiode, fom-dato - 1) |
      | Nei       | 28.01.2020      | Nei  | Ja                 | Avsluttet periode uten medlemskap før inputperiode                                      |
      | Ja        | 01.06.2020      | Nei  | Ja                 | Avsluttet periode med  medlemskap etter inputperiode                                    |
