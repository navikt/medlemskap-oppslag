...
Egenskap: Regelflyt for regel 19.6
  ...
  Scenariomal: Regelflyt for regel 19.6
    ...
    Og skal regel "19.6" gi svaret "<Regel 19.6>"

    Eksempler:
      | Arbeidsadgang til og med | Regel 19.6 | Medlemskap |
      | 20.03.2021               | Ja         | Ja         |
