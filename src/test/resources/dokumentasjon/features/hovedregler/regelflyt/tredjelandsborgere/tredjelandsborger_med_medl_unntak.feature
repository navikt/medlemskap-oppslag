...
Egenskap: Tredjelandsborger med medl unntak.
  ...
  Scenariomal: Tredjelandsborger med medl unntak
    Gitt følgende statsborgerskap i personhistorikken
      | Landkode | Fra og med dato | Til og med dato |
      | USA      | 10.10.1975      |                 |
    ...
    Og følgende medlemsunntak fra MEDL
      ...
      | <Dekning> | 01.01.2018      | 01.06.2021      | Ja        | ENDL    | NOR          | GYLD          |
    ...
    Eksempler:
      | Dekning             | Opphold til og med | Regel 19.2 | Medlemskap |
#      | FTL_2-9_2_ld_jfr_1c | 20.03.2021         | Ja         | Ja         |
      | FTL_2-9_2_ld_jfr_1c | 20.01.2019         | Nei        | Uavklart   |
