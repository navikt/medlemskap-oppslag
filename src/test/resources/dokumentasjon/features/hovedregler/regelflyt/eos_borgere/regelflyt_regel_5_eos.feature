...
Egenskap: Regelflyt for regel 5 for EØS-borgere
  ...
  Scenariomal: Regelflyt regel 5 for EØS-borgere
    ...
    Eksempler:
      | Ytelse     | Antall ansatte | Regel 5 | Medlemskap |
      | DAGPENGER  | 5              | Nei     | UAVKLART   |
      | SYKEPENGER | 5              | Nei     | UAVKLART   |
      | SYKEPENGER | 6              | Ja      | Ja         |