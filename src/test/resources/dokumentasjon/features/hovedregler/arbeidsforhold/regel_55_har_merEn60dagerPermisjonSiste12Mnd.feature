...
Egenskap: Regel 55: Har bruker permisjoner med mer en 60 dager totalt?

  Regel: Regel 55: Har bruker mer en 60 dager i permisjon siste 12 mnd
    ...
    Scenariomal: Person som har ett arbeidsforhold uten permisjoner får Nei
      ...
      Når regel "55" kjøres med følgende parametre
