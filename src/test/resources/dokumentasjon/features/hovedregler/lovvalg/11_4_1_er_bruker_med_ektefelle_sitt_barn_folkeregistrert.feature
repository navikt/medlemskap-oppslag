...
Egenskap: Regel 11.4.1: Er brukers barn folkeregistrert som bosatt i Norge?
  ...
  Scenariomal: Regel 11.4.1 - Er bruker med ektefelle sitt barn folkeregistrert?
  ...
  Scenariomal: Regel 11.4.1 - Uavklart hvis ett eller flere barn bor i Norge og ett eller flere barn ikke bor i Norge
    Gitt følgende familerelasjoner i personhistorikk fra PDL
      | Relatert persons ident | Relatert persons rolle | Min rolle for person |
      | 09069534888            | BARN                   | FAR                  |
