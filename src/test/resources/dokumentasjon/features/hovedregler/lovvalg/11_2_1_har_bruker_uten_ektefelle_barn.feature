...
#  DENNE MÅ TESTES PÅ EN ANNEN MÅTE SIDEN DATAINNHENTINGEN GJØR DENNE SJEKKEN
#  Scenariomal: Regel 11.2.1 - Hvis barnets alder er under 25 år skal svaret være "Ja"
