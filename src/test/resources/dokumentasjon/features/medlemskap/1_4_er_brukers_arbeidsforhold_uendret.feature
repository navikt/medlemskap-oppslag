...
Egenskap: Regel 1.4: Er brukers arbeidsforhold uendret?

  Scenariomal: Regel 1.4: Er brukers arbeidsforhold uendret? Ett arbeidsforhold
  ...
  Scenariomal: Regel 1.4: Er brukers arbeidsforhold uendret? Flere arbeidsforhold
