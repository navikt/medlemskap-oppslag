...
fun assertSvar(
    ...
    Assertions.assertNotNull(
        find,
        "Fant ikke regel $regelId i delsvar i Resultat. Regel det testes på ble ikke kjørt. Følgende regler ble kjørt: " +
            resultat.delresultat.map {
                it.regelId
            },
    )
...
fun assertBegrunnelse(
    regelId: RegelId,
    forventetBegrunnelseFraRegel: String,
    resultat: Resultat,
) {
    val funnetResultat = resultat.finnRegelResultat(regelId)
