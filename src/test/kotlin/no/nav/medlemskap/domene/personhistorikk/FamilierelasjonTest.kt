...
class FamilierelasjonTest {
    ...
    private fun lagPersonhistorikk(
        ...
        Personhistorikk(
            ...
            familierelasjoner, doedsfall, innflyttingTilNorge, utflyttingFraNorge, navn,
        )

    private fun lagStatsborgerskap(
        landkode: String = "NOR",
        fom: LocalDate? = null,
        tom: LocalDate? = null,
    ): Statsborgerskap = Statsborgerskap(landkode = landkode, fom = fom, tom = tom, historisk = false)

    private fun lagAdresse(
        landkode: String = "NOR",
        fom: LocalDate? = null,
        tom: LocalDate? = null,
    ): Adresse = Adresse(landkode = landkode, fom = fom, tom = tom, false)
    ...
    ): Sivilstand = Sivilstand(type, gyldigFraOgMed, gyldigTilOgMed, relatertVedSivilstand)
    ...
    ): ForelderBarnRelasjon = ForelderBarnRelasjon(relatertPersonIdent, relatertPersonsRolle, minRolleForPerson)
}
