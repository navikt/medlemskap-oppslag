...
class EregClientTest {
    ...
    @Test
    fun `tester noekkelinfo response`() {
        val callId = "12345"
        ...
        WireMock.stubFor(
            queryMappingForNoekkelinfo.willReturn(
                WireMock.aResponse()
                    .withStatus(HttpStatusCode.OK.value)
                    .withHeader(HttpHeaders.ContentType, ContentType.Application.Json.toString())
                    .withBody(eregNoekkelinfoResponse)
            )
        )
    ...
    private val queryMappingForNoekkelinfo: MappingBuilder = WireMock.get(WireMock.urlPathEqualTo("/v1/organisasjon/$orgnummer/noekkelinfo"))
    ...
    private val eregNoekkelinfoResponse =
        """
        {
