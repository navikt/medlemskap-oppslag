...
class AaregMapperSteps : No {
    ...
    init {
        ...
        Så<DataTable>("skal mappede periode i arbeidsforhold være") { dataTable: DataTable? ->
            val arbeidsforholdPeriodeForventet = DomenespråkParser.mapArbeidsforhold(dataTable)
            arbeidsforhold.get(0).periode.shouldContainExactly(arbeidsforholdPeriodeForventet)
