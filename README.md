...
## Whiteliste klienter
Det er nå satt opp en WHITELIST_CLIENTS property i vault der man kan legge til aksepterte client id's. Dette må de som skal kalle oss hente ut fra Azure og sende til oss. Helst på mail eller som referanse til applikasjonen i Azure, så ikke id eksponeres ut.
